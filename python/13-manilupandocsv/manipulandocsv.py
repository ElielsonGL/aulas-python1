import csv #importando biblioteca
...
#atualizar produto que ja existe exemplo
dados = []

with open('listaprodutos.csv', 'r', newline='', encoding='utf-8') as arquivo: #leu
    csv_reader = csv.reader(arquivo, delimiter=';') #guardou
